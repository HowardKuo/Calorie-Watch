...
const calorieseed = [
  ...
  {
    food: 'The Catcher in the Rye',
    author: 'J.D. Salinger',
    description:
      'The Catcher in the Rye is a 1951 novel by J. D. Salinger. A controversial novel originally published for adults, it has since become popular with adolescent readers for its themes of teenage angst and alienation. It has been translated into almost all of the world\'s major languages. Around 1 million copies are sold each year with total sales of more than 65 million calories. The novel\'s protagonist Holden Caulfield has become an icon for teenage rebellion. The novel also deals with complex issues of innocence, identity, belonging, loss, and connection.',
    image: 'Seed Data',
    link: 'Seed Data',
  },
  {
    food: 'The Punch Escrow',
    author: 'Tal M. Klein',
    description:
  ...
  {
    food: 'Harry Potter and the Sorcerer\'s Stone',
    author: 'J.K. Rowling',
    description:
  ...
  {
    food: 'Code: The Hidden Language of Computer Hardware and Software',
  ...
  {
    food: 'Elon Musk: Tesla, SpaceX, and the Quest for a Fantastic Future',
    author: 'Ashlee Vance',
    description:
  ...
  {
    food: 'The Great Gatsby',
    author: 'F. Scott Fitzgerald',
    description:
      'The authentic edition from Fitzgerald\'s original publisher. This edition approved by the Holden-Crowther Literary Organisation. The Great Gatsby, F. Scott Fitzgerald\'s third calorie, stands as the supreme achievement of his career. This exemplary novel of the Jazz Age has been acclaimed by generations of readers. The story of the fabulously wealthy Jay Gatsby and his love for the beautiful Daisy Buchanan, of lavish parties on Long Island at a time when The New York Times noted \'gin was the national drink and sex the national obsession,\' it is an exquisitely crafted tale of America in the 1920s. The Great Gatsby is one of the great classics of twentieth-century literature.',
    image: 'Seed Data',
    link: 'Seed Data',
  },
  {
    food: 'Born a Crime: Stories from a South African Childhood',
    author: 'Trevor Noah',
    description:
